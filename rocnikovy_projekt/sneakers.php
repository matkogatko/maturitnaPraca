...
<body>
  ...
  <div class="product-container">
    ...
    $sql = "SELECT * FROM products WHERE category = 'sneakers' ORDER BY created_at DESC";
    ...
    while ($row = $result->fetch_assoc()) {
      ...
      if (isset($_SESSION['valid'])) {
        ...
        if (isset($_SESSION['role']) && $_SESSION['role'] == 'admin_for_products') {
          ...
          echo "<form method='post' action='sneakers.php'>";
          ...
          if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['delete_id'])) {
            ...
            $delete_stmt->execute();
            header("Location: sneakers.php"); // Refresh cart page
            exit();
          }
        } else {
